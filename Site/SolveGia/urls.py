...
from .views import index, generate_random_variant, show_vars, show_variant, show_task
...
urlpatterns = [
    ...
    path('show-task/cat-<str:cat_name>/id-<int:task_id>', show_task, name='show-task'),
]
